...
#define configUSE_MUTEXES               1 /* REQUIRED for priority inheritance */
#define configUSE_RECURSIVE_MUTEXES     1
#define configUSE_COUNTING_SEMAPHORES   1
#define configUSE_QUEUE_SETS            0

/* ---- Software timers (used by watchdog) ---- */
...
#define configCHECK_FOR_STACK_OVERFLOW  2 /* 2 = full check, calls hook */
#define configUSE_MALLOC_FAILED_HOOK    1 /* calls vApplicationMallocFailedHook */
#define configASSERT(x) if((x) == 0) { taskDISABLE_INTERRUPTS(); for(;;); }

/* ---- API includes ---- */
#define INCLUDE_vTaskDelay              1
#define INCLUDE_vTaskDelayUntil         1 /* REQUIRED for fixed-rate tasks */
